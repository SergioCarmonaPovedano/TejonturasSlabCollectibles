const cardData = [
  { id: 'SV-0001', name: 'Pikachu & Zekrom GX', set: 'Team Up', number: '33/181', year: 2019, finish: 'Holo', language: 'English', rarity: 'Ultra Rare', type: 'TAG TEAM GX', grader: 'CGC', grade: 8.5, gradeLabel: 'NM/MINT+', cert: '6077330161', price: 'Consultar', status: 'available', featured: 1, front: 'assets/pikachu-zekrom-front.webp', back: 'assets/pikachu-zekrom-back.webp' },
  ...
  { id: 'SV-0014', name: 'Suicune V', set: 'Crown Zenith', number: 'GG38/GG70', year: 2023, finish: 'Holo', language: 'English', rarity: 'Galarian Gallery', type: 'Pokémon V', grader: 'CGC', grade: 10, gradeLabel: 'GEM MINT', cert: '6113633067', price: 'Consultar', status: 'available', featured: 0, front: 'assets/Suicune-Front.webp', back: 'assets/Suicune-Back.webp' },
  { id: 'SV-0015', name: 'Gardevoir/Sylveon GX', set: 'Unbroken Bonds', number: '130/214', year: 2019, finish: 'Holo', language: 'English', rarity: 'Ultra Rare', type: 'TAG TEAM GX', grader: 'PSA', grade: 9, gradeLabel: 'MINT', cert: '138496819', price: 'Consultar', status: 'available', featured: 0, front: 'assets/Sylveon-Gardevoir-Front.webp', back: 'assets/Sylveon-Gardevoir-Back.webp' },
  { id: 'SV-0016', name: 'Umbreon Gold Star', set: 'Celebrations', number: '17/17', year: 2021, finish: 'Holo', language: 'English', rarity: 'Classic Collection', type: 'Pokémon Star', grader: 'CGC', grade: 8.5, gradeLabel: 'NM/MINT+', cert: '6146238003', price: 'Consultar', status: 'available', featured: 0, front: 'assets/Umbreon-8,5CGC-Front.webp', back: 'assets/Umbreon-8,5CGC-Back.webp' },
  { id: 'SV-0017', name: 'Umbreon Gold Star', set: 'Celebrations', number: '17/17', year: 2021, finish: 'Holo', language: 'English', rarity: 'Classic Collection', type: 'Pokémon Star', grader: 'PSA', grade: 9, gradeLabel: 'MINT', cert: '138496869', price: 'Consultar', status: 'available', featured: 0, front: 'assets/Umbreon-PSA-Front.webp', back: 'assets/Umbreon-PSA-Back.webp' },
  ...
  { id: 'SV-0019', name: 'Vaporeon', set: 'Brilliant Stars', number: 'TG02/TG30', year: 2022, finish: 'Holo', language: 'English', rarity: 'Trainer Gallery', type: 'Pokémon', grader: 'CGC', grade: 10, gradeLabel: 'GEM MINT', cert: '6105062079', price: 'Consultar', status: 'available', featured: 0, front: 'assets/Vaporeon-Front.webp', back: 'assets/Vaporeon-Back.webp' },
